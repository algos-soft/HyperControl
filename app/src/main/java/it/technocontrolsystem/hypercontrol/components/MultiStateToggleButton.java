...
public class MultiStateToggleButton extends ToggleButton {
    ...
    public void setElements(CharSequence[] texts, boolean[] selected) {
        ...
        LinearLayout mainLayout = (LinearLayout) inflater.inflate(R.layout.view_multi_state_toggle_button,null);
    ...
    public void setButtonState(Button button, boolean selected) {
        ...
        if (selected) {
           ...
           // button.setTextAppearance(this.getContext(),R.style.WhiteBoldText);
        } else {
            button.setBackgroundResource(R.drawable.button_not_pressed);
         //   button.setTextAppearance(this.getContext(), R.style.BlackNormalText);
        }
    }
