...
public class HCRegistrationIntentService extends IntentService {

    private static final String TAG = "RegIntentService";
    private static final String[] TOPICS = {"global"};

    public HCRegistrationIntentService() {
        super(TAG);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            synchronized (TAG) {
                ...
                Prefs.getEditor().putBoolean(Prefs.SENT_TOKEN_TO_SERVER, true).apply();
            ...
            Prefs.getEditor().putBoolean(Prefs.SENT_TOKEN_TO_SERVER, false).apply();
